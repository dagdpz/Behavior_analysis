...
GLO.append_pdfs                     =   0;
GLO.parent_folder                   =   '';
GLO.folder_to_save                  =   'Y:\Projects\PPC_pulv_eye_hand\behavior\beh_analysis\Bacchus\20191127';
...
GLO.summary                         =   [3]; %which plots (vector of number of -1 for all plots) [1 2 3 5 10]
