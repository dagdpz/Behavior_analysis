...
GLO.append_pdfs                     =   0;
GLO.parent_folder                   =   '';
GLO.folder_to_save                  =   'Y:\Projects\PPC_pulv_eye_hand\behavior\beh_analysis\Bacchus\20200325';
...
GLO.summary                         =   [2]; %which plots (vector of number of -1 for all plots) [1 2 3 5 10]
...
dates_subject_in{1}             = repmat({20200325},1,2);;
batching{1}.runs                = {3;4};  % either empty or specific runs specified
