...
GLO.append_pdfs                     =   0;
GLO.parent_folder                   =   '';
GLO.folder_to_save                  =   'Y:\Projects\Simultaneous_dPul_PPC_recordings\behavior\beh_analysis\Bacchus\LIP_dPul_9s';
...
GLO.reaches_effectors               = {'3'};
GLO.types_to_plot                   = {'4'};
GLO.saccades.effectors_raw_xy       = {'3'};
GLO.reaches.effectors_raw_xy        = {'3'};
...
steady.downsampling               = 1;
 ...
 load('Y:\Projects\Simultaneous_dPul_PPC_recordings\ephys\dPul_LIP_Bac_9_sessions\behaviour_filelist.mat');
...
group{1}                        = repmat({'Bacchus'},size(filelist_formatted_control,1),1);
...
batching{1}.inactivation_sites   = {'R','R','R','R','R','R','R','R','R'};
