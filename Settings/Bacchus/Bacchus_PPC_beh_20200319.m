...
GLO.append_pdfs                     =   0;
GLO.parent_folder                   =   '';
GLO.folder_to_save                  =   'Y:\Projects\PPC_pulv_eye_hand\behavior\beh_analysis\Bacchus\20200319';
...
group{1}                        = {'Bacchus'};
dates_subject_in{1}             = {20200319};;
batching{1}.runs                = {8};  % either empty or specific runs specified
