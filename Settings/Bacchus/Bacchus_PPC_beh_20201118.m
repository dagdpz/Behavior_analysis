...
GLO.append_pdfs                     =   0;
GLO.parent_folder                   =   '';
GLO.folder_to_save                  =   'Y:\Projects\Simultaneous_dPul_PPC_recordings\behavior\beh_analysis\Bacchus\20201119';
...
dates_subject_in{1}             = repmat({20201119},1,1);;
...
group{2}                        = repmat({'Bacchus'},1,4);
dates_subject_in{2}             = repmat({20201112},1,4);;
batching{2}.runs                = {3;4;5;6};  % either empty or specific runs specified
