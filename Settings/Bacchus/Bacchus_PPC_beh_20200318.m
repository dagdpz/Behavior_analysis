...
GLO.append_pdfs                     =   0;
GLO.parent_folder                   =   '';
GLO.folder_to_save                  =   'Y:\Projects\PPC_pulv_eye_hand\behavior\beh_analysis\Bacchus\20200318';
...
group{1}                        = repmat({'Bacchus'},3,1);
dates_subject_in{1}             = repmat({20200318},3,1);;
batching{1}.runs                = {4;5;6};  % either empty or specific runs specified
