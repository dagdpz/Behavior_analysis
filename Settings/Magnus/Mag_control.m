...
GLO.append_pdfs                     =   0;
GLO.parent_folder                   =   '';
GLO.folder_to_save                  =   'Y:\Projects\Simultaneous_dPul_PPC_recordings\behavior\beh_analysis\Magnus\dPul_control';
...
group{1}                        = repmat({'Magnus'},1,12);
dates_subject_in{1}             = {20191113,20191113,20191113,20191120,20191120,20191120, ...
    20191211,20191211,20191211,20191213,20191213,20191213};
batching{1}.runs                = {2;5;7;2;4;6;2;4;6;2;4;6};  % either empty or specific runs specified
batching{1}.inactivation_sites   = repmat({'R'},1,12);
batching_type{1}                = 1; % 1 run by run, 2 session by session, 3 group by group
batching{1}.range_of_dates      = 0;


subject_ID{2}='Experimental';
group{2}                        = repmat({'Magnus'},1,18);
dates_subject_in{2}                = {20191113,20191113,20191113,20191113,20191120,20191120,20191120,20191120, ...
   20191211,20191211,20191211,20191211,20191211,20191211,20191213,20191213,20191213,20191213,20191213};
batching{2}.runs                = {10;12;14;16;9;11;14;16;9;11;13;15;17;9;11;13;15;17};  % either empty or specific runs specified
batching{2}.inactivation_sites   = repmat({'R'},1,18);
