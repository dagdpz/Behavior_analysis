...
GLO.append_pdfs                     =   0;
GLO.parent_folder                   =   '';
GLO.folder_to_save                  =   'Y:\Projects\Simultaneous_dPul_PPC_recordings\behavior\beh_analysis\Linus\20210616';
...
dates_subject_in{1}             = repmat({20210616},1,1);;
...
dates_subject_in{2}             = repmat({20210616},1,3);;
batching{2}.runs                = {3;4;5};  % either empty or specific runs specified
