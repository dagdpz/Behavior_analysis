...
GLO.append_pdfs                     =   0;
GLO.parent_folder                   =   '';
GLO.folder_to_save                  =   'Y:\Projects\Simultaneous_dPul_PPC_recordings\behavior\beh_analysis\Linus\20211021';
...
dates_subject_in{1}             = repmat({20211021},1,1);;
...
dates_subject_in{2}             = repmat({20211021},1,1);;
batching{2}.runs                = {6};  % either empty or specific runs specified
