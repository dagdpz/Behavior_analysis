...
GLO.append_pdfs                     =   0;
GLO.parent_folder                   =   '';
GLO.folder_to_save                  =   'Y:\Projects\Simultaneous_dPul_PPC_recordings\behavior\beh_analysis\Linus\20211126';
...
dates_subject_in{1}             = repmat({20211126},1,1);
...
group{2}                        = repmat({'Linus'},1,4);
dates_subject_in{2}             = repmat({20211126},1,4);
