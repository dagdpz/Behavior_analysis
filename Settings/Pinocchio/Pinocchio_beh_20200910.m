...
GLO.append_pdfs                     =   0;
GLO.parent_folder                   =   '';
GLO.folder_to_save                  =   'Y:\Projects\Simultaneous_dPul_PPC_recordings\behavior\beh_analysis\Pinocchio\20200910';
...
GLO.summary                         =   [-1]; %which plots (vector of number of -1 for all plots) [1 2 3 5 10]
...
%next 3 for plotting
GLO.saccades_effectors              = {'6'};
GLO.reaches_effectors               = {'6'};
GLO.types_to_plot                   = {'4'};
...
group{1}                        = repmat({'Pinocchio'},1,2);
dates_subject_in{1}             = repmat({20200910},1,2);;
batching{1}.runs                = {2;4};  % either empty or specific runs specified
